...
function SignupForm({
    ...
    const handleSignWithGitHub = async () => {
        setLoadingFlag('gitHub', true)

        await signIn('github', {
            callbackUrl: '/dashboard',
        })

        setLoadingFlag('gitHub', false)
    }
    ...
    return (
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <Card>
                <CardHeader>
                    <CardTitle className={`${figtree.className} text-xl`}>
                        Gitback
                    </CardTitle>
                    <CardDescription>
                        Please sign the form below for sign up
                    </CardDescription>
                </CardHeader>
